        ...
        win.webContents.executeJavaScript(`
            ...
            const enforceGlass = () => {
                try {
                    ...
                    if (sidebar) {
                        // Fade into the orb background
                        sidebar.style.setProperty('background', 'linear-gradient(to right, rgba(255,255,255,0.03) 0%, transparent 100%)', 'important');
                    ...
                    const applyHeaderGlass = (el) => {
                        if (el) {
                            ...
                            el.style.setProperty('background', 'linear-gradient(to right, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.01) 100%)', 'important');
                    ...
                    const roots = document.querySelectorAll('html, body, #root, #root > div, #root > div > div, main, aside, header, nav, .bg-background, .bg-zinc-950, .bg-[#121212], .monaco-workbench, .part, .titlebar');
                    roots.forEach(r => {
